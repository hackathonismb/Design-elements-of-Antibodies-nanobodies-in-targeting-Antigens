...
Why should we solve it? Antibodies are widely used in a number of applications.  Understanding the particular residue or domain epitope-paratope interaction can help in predicting binding interactions which can assist in the area of drug design and therapeutics.
Flow chart 
